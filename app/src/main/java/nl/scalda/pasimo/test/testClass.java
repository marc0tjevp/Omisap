...
////		System.out.println(DAOFactory.getTheFactory().getDAOTeacher().readAll());
////		System.out.println(DAOFactory.getTheFactory().getDAOTeacher().readByEmployeeNumber(123456));
//   
////		
