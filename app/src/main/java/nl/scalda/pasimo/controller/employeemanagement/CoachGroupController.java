...
public class CoachGroupController extends ActionSupport {
    ...
    public Set<CoachGroup> coachGroup = CoachGroupService.getInstance().readAll();
    ...
    public Set<CoachGroup> getCoachGroup() {
        return coachGroup;
    }

    public void setCoachGroup(Set<CoachGroup> coachGroup) {
