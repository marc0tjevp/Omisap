...
public class MYSQLDAONote implements IDAONote {
	...
	public void create(Note note) {
		...
		try {
			...
			String sql = "INSERT INTO note (noteID, ovNumber,title, message, employeeAbbreviation, creationDate, lastEdit) VALUES(:noteID, :ovNumber, :title, :message, :employeeAbbreviation, :creationDate, :lastEdit);";
			...
			query.setParameter("employeeAbbreviation", note.getMadeBy().getAbbreviation());
	...
	public Note read(int id) {
		...
		try {
			...
			n.setEmployeeAbbreviation(String.valueOf(obj[4]));
