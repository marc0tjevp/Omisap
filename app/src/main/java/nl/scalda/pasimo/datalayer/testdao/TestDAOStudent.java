...
public class TestDAOStudent implements IDAOStudent {
	...
	public void addStudentTestData(){
		...
		Student s = new Student(215443, 2016, "student@email.com", "Erin", "", "Boshart", "211543", 1998, note, 05, 12);
		Student z = new Student(215444, 2016, "student0@email.com", "Rien", "", "Hannewijk", "211544", 1998, note, 05, 12);
		create(s);	
		create(z);
	}
